"""pruebas_23941 URL Configuration
...
admin.site.site_header = "pruebas"
admin.site.site_title = "pruebas Admin Portal"
admin.site.index_title = "pruebas Admin"

# swagger
api_info = openapi.Info(
    title="pruebas API",
    default_version="v1",
    description="API documentation for pruebas App",
)
